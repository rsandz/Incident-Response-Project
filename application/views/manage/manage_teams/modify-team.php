<?php echo form_open('Manage/teams/remove_users/'.$team_id);?>
<section class="section is-top-marginless">
					...
					<div class="level-left">
						<div class="level-item">
							<div class="field is-grouped">
								<div class="control">
									<?php echo anchor('Manage/teams/add_users/'.$team_id, 'Add User', 'class="button is-info"');?>
								</div>
								<div class="control">
	...
	<div>
		<?php echo anchor('Manage/teams', 'Back', 'class="button is-info"');?>
	</div>
</section>
